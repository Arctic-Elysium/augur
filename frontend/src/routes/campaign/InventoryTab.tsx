  ...
  return (
    <div className="stack">
      <p className="field__hint">
        The game master can give and take items during play. Anything added here
        shows up on the sheet the same way.
      </p>
      <div className="sheets">
        {roster.map((c) => (
          <Carried key={c.id} character={c} onChanged={() => void reload()} />
        ))}
      </div>
    </div>
  );
