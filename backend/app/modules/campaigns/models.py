...
class Campaign(UUIDPrimaryKey, Timestamped, Base):
    ...
    # Tone, content dials, difficulty, house rules, the setting primer, the
    # campaign arc, and standing directives. Schema-validated in the service
    # layer, stored loose so settings can evolve without migrations.
